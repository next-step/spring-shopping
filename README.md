...
## API 설계 
- [ ] 상품을 1개 조회한다. GET /api/products/{id}
- [ ] 상품을 여러개 조회한다.  GET /api/products
- [ ] 상품을 1개 등록한다. POST /api/products
- [ ] 상품을 1개 수정한다. PUT /api/proucts/{id}
- [ ] 상품을 1개 삭제한다. DELETE /api/products/{id}
- [ ] API 는 Restful 하게 설계한다. 
- [ ] API  요청과 응답은 JSON 형식으로 주고 받는다.
...
- [ ] 상품 이름은 공백을 포함하여 15자 초과하면 에러가 발생한다
