...
class OrderItemsTest {
    ...
    void getAllPrice() {
        ...
        orderItems.add(new OrderItem(1L, "테스트 상품1", new Money("1000.00"), new Quantity(3), null));
        orderItems.add(new OrderItem(1L, "테스트 상품2", new Money("2000.00"), new Quantity(2), null));
        orderItems.add(new OrderItem(1L, "테스트 상품3", new Money("500.00"), new Quantity(10), null));
