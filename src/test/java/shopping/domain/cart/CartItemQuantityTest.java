...
class CartItemQuantityTest {
    ...
    void createQuantity(final int value) {
        CartItemQuantity cartItemQuantity = CartItemQuantity.from(value);

        assertThat(cartItemQuantity.getValue()).isEqualTo(value);
    }
    ...
    void validateQuantity(final int value) {
        Assertions.assertThatThrownBy(() -> CartItemQuantity.from(value))
